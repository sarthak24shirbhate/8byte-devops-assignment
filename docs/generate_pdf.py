...
def generate_pdf():
    pdf_path = os.path.join(
        ...
        "8Byte_DevOps_Assignment_Challenges_Sarthak_Shirbhate.pdf",
    )
    ...
    story.append(
        Paragraph(
            "8Byte.ai DevOps / SRE Assignment: Challenges & Resolutions", title_style
        )
    )
    story.append(
        Paragraph("Author: Sarthak Shirbhate (DevOps / SRE Engineer)", subtitle_style)
    )
    story.append(Spacer(1, 8))

    meta_data = [
        [
            Paragraph("<b>Candidate:</b> Sarthak Shirbhate", body_style),
            Paragraph("<b>Target Role:</b> Senior DevOps / SRE Engineer", body_style),
        ],
        [
            Paragraph("<b>Target Cloud:</b> AWS (us-east-1)", body_style),
            Paragraph(
                "<b>Repository:</b> github.com/sarthak24shirbhate/8byte-devops-assignment",
                body_style,
            ),
        ],
    ]
    ...
    for c in challenges:
        ...
        table_data = [
            [
                Paragraph("<b>Problem:</b>", label_style),
                Paragraph(c["problem"], body_style),
            ],
            [
                Paragraph("<b>Root Cause:</b>", label_style),
                Paragraph(c["root_cause"], body_style),
            ],
            [
                Paragraph("<b>Resolution:</b>", label_style),
                Paragraph(c["resolution"], body_style),
            ],
            [
                Paragraph("<b>Takeaway:</b>", label_style),
                Paragraph(c["takeaway"], body_style),
            ],
        ]
